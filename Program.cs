...
namespace Malta.Series
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			Console.WriteLine("Obrigado por acessar nossos serviços.");
			Console.ReadLine();
		}
		...
		private static void AtualizarSerie()
		{
			...
			int entradaClassificaçao = int.Parse(Console.ReadLine());
		...
		private static void InserirSerie()
		{
			...
			Serie novaSerie = new Serie(id: repositorio.ProximoId(),
										...
										classificaçao: entradaClassificaçao
										);
		...
		{
			Console.WriteLine();
			Console.WriteLine("Malta Séries a sua disposição!!!");
